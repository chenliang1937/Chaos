...
public abstract class JCVideoPlayer extends FrameLayout implements View.OnClickListener, View.OnTouchListener, SeekBar.OnSeekBarChangeListener, SurfaceHolder.Callback, JCMediaManager.JCMediaPlayerListener {
  ...
  protected void setStateAndUi(int state) {
    ...
    switch (CURRENT_STATE) {
      case CURRENT_STATE_NORMAL:
        if (com.meiya.chaos.widget.JCMediaManager.intance().listener == this) {
          com.meiya.chaos.widget.JCMediaManager.intance().mediaPlayer.release();
        }
        break;
  ...
  public void onClick(View v) {
    ...
    if (i == R.id.start) {
      ...
      if (CURRENT_STATE == CURRENT_STATE_NORMAL || CURRENT_STATE == CURRENT_STATE_ERROR) {
        ...
        com.meiya.chaos.widget.JCMediaManager.intance().mediaPlayer.pause();
        setStateAndUi(CURRENT_STATE_PAUSE);
        if (JC_BURIED_POINT != null && com.meiya.chaos.widget.JCMediaManager.intance().listener == this) {
        ...
        com.meiya.chaos.widget.JCMediaManager.intance().mediaPlayer.start();
      ...
      if (IF_CURRENT_IS_FULLSCREEN) {
        ...
        //to fullscreen
        com.meiya.chaos.widget.JCMediaManager.intance().mediaPlayer.setDisplay(null);
        com.meiya.chaos.widget.JCMediaManager.intance().lastListener = this;
        com.meiya.chaos.widget.JCMediaManager.intance().listener = null;
  ...
  protected void prepareVideo() {
    if (com.meiya.chaos.widget.JCMediaManager.intance().listener != null) {
      com.meiya.chaos.widget.JCMediaManager.intance().listener.onCompletion();
    }
    com.meiya.chaos.widget.JCMediaManager.intance().listener = this;
//        addSurfaceView();
    com.meiya.chaos.widget.JCMediaManager.intance().prepareToPlay(getContext(), url);
    if (!IF_CURRENT_IS_FULLSCREEN) {
...
//        surfaceView.setOnClickListener(this);
    ...
    if (id == R.id.surface_container) {
      switch (event.getAction()) {
              ...
              if (absDeltaX > threshold || absDeltaY > threshold) {
                if (absDeltaX >= threshold) {
                  if (CURRENT_STATE == CURRENT_STATE_PLAYING || CURRENT_STATE == CURRENT_STATE_PAUSE) {
                    changePosition = true;
                    downPosition = com.meiya.chaos.widget.JCMediaManager.intance().mediaPlayer.getCurrentPosition();
                    if (JC_BURIED_POINT != null && com.meiya.chaos.widget.JCMediaManager.intance().listener == this) {
        ...
        case MotionEvent.ACTION_UP:
          ...
          if (changePosition) {
            com.meiya.chaos.widget.JCMediaManager.intance().mediaPlayer.seekTo(resultTimePosition);
            int duration = com.meiya.chaos.widget.JCMediaManager.intance().mediaPlayer.getDuration();
  ...
  private void showProgressDialog(float deltaX) {
    if (dlgProgress == null) {
      ...
      dlgProgress = new Dialog(getContext(), R.style.jc_style_dialog_progress);
    ...
    int totalTime = com.meiya.chaos.widget.JCMediaManager.intance().mediaPlayer.getDuration();
    resultTimePosition = (int) (downPosition + deltaX * totalTime / screenWidth);
    dlgProgressCurrent.setText(com.meiya.chaos.widget.JCUtils.stringForTime(resultTimePosition));
